        ...
        <div className="not-prose my-6 rounded-2xl border-2 border-brand-blue/15 bg-brand-blue p-6 text-brand-white">
          ...
          <div className="mt-3 space-y-2 font-body text-sm text-brand-white/85">
            <p className="flex items-center gap-2">
              ...
              <a className="font-semibold text-brand-white underline decoration-brand-gold decoration-2 underline-offset-4 hover:text-brand-gold" href="mailto:info@msl-itech.com">
                info@msl-itech.com
              </a>
            </p>
            <p className="flex items-center gap-2">
