...
import { JsonLd, localBusinessBeSchema, localBusinessMaSchema, localBusinessCaSchema } from "@/components/JsonLd";
...
export default function ContactPage() {
  ...
  return (
    <>
      ...
      <JsonLd id="ld-localbusiness-ca" data={localBusinessCaSchema} />
