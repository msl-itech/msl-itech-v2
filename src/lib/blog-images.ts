...
export const blogImageBySlug: Record<string, string> = {
  ...
  "donnees-propres-erp-avant-ia-odoo-maroc": donneesProprresErpImg,
  "facturation-electronique-transformation-digitale-maroc": facturationTransformationImg,
  "odoo-saas-on-premise-hybride-maroc-2026": odooSaasOnpremiseImg,
  "devis-encaissement-odoo-automatisation-roi-maroc": devisEncaissementOdooImg,
  "daf-marocain-pilotage-strategique-odoo-2026": dafMarocainOdooImg,
  "erp-odoo-relances-automatiques-ruptures-stock-ia-maroc": erpAgentiqueOdooImg,
  "migration-excel-vers-odoo-maroc-methode": migrationExcelOdooImg,
